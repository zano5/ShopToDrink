...
public class FragmentVodka extends Fragment {
    ...
    private FirebaseRecyclerAdapter<Item,VodkaViewHolder> adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Query query = db.orderByChild("type").equalTo("Vodka");
        ...
        adapter = new FirebaseRecyclerAdapter<Item, VodkaViewHolder>(Item.class,R.layout.catalogue_view,VodkaViewHolder.class,query) {
            @Override
            protected void populateViewHolder(final VodkaViewHolder viewHolder, final Item model, int position) {
    ...
    private static  class VodkaViewHolder extends  RecyclerView.ViewHolder{

        private View mView;

        public VodkaViewHolder(View itemView) {
            super(itemView);
            mView = itemView;
        }
